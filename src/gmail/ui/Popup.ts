...
export class Popup {
  ...
  constructor(options: PopupOptions) {
    this.options = {
      ...
      destroyOnClose: true,
      animationEnabled: settingsState.animations,
      ...options
    };
  ...
  private create(): void {
    ...
    background.id = this.options.id || 'popup-' + Math.random().toString(36).substr(2, 9);
    ...
    const header = stringToHTML(
      ...
      <div class="whatsnewHeader">
        ...
        ${this.options.subtitle ? `<p>${this.options.subtitle}</p>` : ''}
      </div>
    ...
    const footer = this.options.footer 
      ? (typeof this.options.footer === 'string' 
        ? stringToHTML(this.options.footer).firstChild as HTMLElement 
        : this.options.footer)
      : Popup.createSocialFooter();
  ...
  public static createSocialFooter(): HTMLElement {
    return stringToHTML(
      /* html */ `
      <div class="whatsnewFooter">
        <div>
        Report bugs and feedback: 
          <a class="socials" href="https://github.com/SethBurkart123/BetterGmail" style="background: none !important; margin: 0 5px; padding:0;">
          ...
          <a class="socials" href="https://chromewebstore.google.com/detail/..." style="background: none !important; margin: 0 5px; padding:0;">
          ...
          <a class="socials" href="https://discord.gg/..." style="background: none !important; margin: 0 5px; padding: 0;">
  ...
  public show(): void {
    if (this.isDestroyed || !this.element || !this.container) return;
