<script lang="ts">
  ...
  import { OpenThemeCreator } from '@/gmail/ui/ThemeCreator'
  import shareTheme from '@/gmail/ui/themes/shareTheme'
  import { InstallTheme } from '@/gmail/ui/themes/downloadTheme'
  ...
  import { OpenStorePage } from '@/gmail/ui/renderStore'
