        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {#each Array(9) as _}
            <div class="overflow-hidden relative rounded-lg animate-pulse">
              ...
              <!-- Gradient overlay -->
              <div class="absolute right-0 bottom-0 left-0 h-16 bg-gradient-to-t to-transparent from-zinc-300 dark:from-zinc-700">
                <!-- Title placeholder -->
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {#each filteredBackgrounds.filter((bg: Background) => {
            ...
            >
              ...
              {/if}
              <div class="flex absolute inset-0 justify-center items-center bg-black bg-opacity-50 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
