<script lang="ts">
  ...
  import { Popup } from '@/gmail/ui/Popup'
    ...
    new Popup({
      ...
      content: /* html */ `
        <div class="whatsnewTextContainer" style="overflow-y: scroll;">
          <img src="${settingsState.DarkMode ? 'https://raw.githubusercontent.com/SethBurkart123/BetterGmail/main/src/resources/branding/dark.jpg' : 'https://raw.githubusercontent.com/SethBurkart123/BetterGmail/main/src/resources/branding/light.jpg'}" class="aboutImg" />
          <p>BetterGmail is a in development extension that aims to improve the Gmail experience.</p>
        </div>
      `
    });
