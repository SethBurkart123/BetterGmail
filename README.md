...
- Browser Support
  ...
  - Firefox (Experimental - available [here](https://addons.mozilla.org/en-US/firefox/addon/bettergmail/)
  - Safari (Experimental - only available via compilation)

## Creating Custom Themes

If you are looking to create custom themes, I would recommend you start at the official documentation [here](https://bettergmail.gitbook.io/bettergmail-docs). You can see some premade examples along with a compilation script that can be used to allow for CSS frameworks and libraries such as SCSS to be used [here](https://github.com/BetterSEQTA/BetterSEQTA-Theme-Generator). 
...
```
git clone https://github.com/SethBurkart123/BetterGmail
```
...
<a href="https://github.com/SethBurkart123/BetterGmail/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=SethBurkart123/BetterGmail" />
</a>

Want to contribute? [Click Here!](https://github.com/SethBurkart123/BetterGmail/blob/main/CONTRIBUTING.md)
## Credits

In development by SethBurkart123. Some source code was taken from the [BetterSEQTA](https://github.com/BetterSEQTA/BetterSEQTA-Plus) extension (also in development by me).

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=SethBurkart123/BetterGmail&type=Date)](https://star-history.com/#sethburkart123/BetterGmail&Date)